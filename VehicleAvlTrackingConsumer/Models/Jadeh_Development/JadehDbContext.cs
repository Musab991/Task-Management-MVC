...
public partial class JadehDevelopmentDbContext : DbContext
{
    public JadehDevelopmentDbContext()
    {
    }

    public JadehDevelopmentDbContext(DbContextOptions<JadehDevelopmentDbContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=84.8.112.156;Database=AVL22_dev;TrustServerCertificate=True;User ID=sa;Password=6psRXodK;Connect Timeout=60;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<ContractType>(entity =>
        {
            ...
            entity.HasOne(d => d.Dictionary).WithMany(p => p.ContractTypes).OnDelete(DeleteBehavior.ClientSetNull);
        });
        ...
        modelBuilder.Entity<VehiclesAvlDataPartitioned>(entity =>
        {
            entity.HasKey(e => e.Id)
                .HasName("PK_VehiclesAvlData_Id")
                .IsClustered(false);

            entity.HasIndex(e => e.MovementTime, "CIX_VehiclesAvlData_MovementTime").IsClustered();
        ...
        {
            entity.Property(e => e.Id).ValueGeneratedNever();
            entity.Property(e => e.Imei).HasColumnType("nvarmax(2000)");
